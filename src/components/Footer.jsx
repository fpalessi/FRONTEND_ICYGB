    ...
    <Container>
      <Left>
        ...
        <Description>
          ...
          favoritas, por lo que garantiza los mejores precios del mercado con un
          margen de 2,88% sobre el precio del competidor más barato. En ICYGB
          contamos con la mayor variedad del mercado de zapas, desde zapatillas
          para practicar deporte a las últimas tendencias urbanas. Aquí podrás
          encontrar los últimos modelos de las grandes marcas a los precios que
          siempre soñaste.
        </Description>
      </Left>
      <Center>
